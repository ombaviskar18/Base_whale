...
const MOCK_REWARDS: Reward[] = [
  // NFT Rewards
  {
    id: 'whale-hunter-genesis',
    title: 'Whale Hunter Genesis NFT',
    description: 'Exclusive genesis NFT for early whale hunters. Gives access to special events and airdrops.',
    type: 'nft',
    pointsCost: 50000,
    rarity: 'legendary',
    network: 'base',
    ...
    maxSupply: 100,
    claimed: false,
    requirements: ['Level 10+', 'Win 50+ games']
  },
  {
    id: 'crypto-detective-badge',
    title: 'Crypto Detective Badge',
    description: 'NFT badge proving your whale hunting skills. Show off your expertise!',
    type: 'nft',
    pointsCost: 25000,
    rarity: 'epic',
    network: 'base',
  ...
  {
    id: 'whale-tracker-nft',
    title: 'Whale Tracker NFT',
    description: 'Dynamic NFT that updates based on your whale hunting achievements.',
    type: 'nft',
    pointsCost: 15000,
    rarity: 'rare',
    network: 'base',
  ...
  {
    id: 'whale-token',
    title: '$WHALE Social Token',
    description: 'Exclusive whale hunter community token with governance rights.',
    type: 'token',
    pointsCost: 10000,
    rarity: 'rare',
    network: 'ethereum',
    ...
    maxSupply: 2000,
    claimed: false,
    requirements: ['Complete 10 games']
  },
  {
    id: 'usdc-reward',
    title: '50 USDC',
  ...
  {
    id: 'whale-spotter',
    title: 'Whale Spotter Badge',
    description: 'Digital badge for identifying your first whale correctly.',
    type: 'badge',
    pointsCost: 1000,
    rarity: 'common',
    network: 'base',
  ...
  {
    id: 'trivia-master',
    title: 'Trivia Master Badge',
    description: 'Awarded for perfect scores in whale trivia challenges.',
    type: 'badge',
    pointsCost: 8000,
    rarity: 'epic',
    network: 'base',
    ...
    maxSupply: 200,
    claimed: false,
    requirements: ['Score 100% on 5 games']
  },
  ...
  // Access Rewards
  {
    ...
    description: 'Access to exclusive XMTP channels with whale hunting pros.',
    type: 'access',
    pointsCost: 20000,
    rarity: 'epic',
    network: 'ethereum',
  ...
  },
  {
    ...
    description: 'Get early access to new whale hunting features and AI improvements.',
    type: 'access',
    pointsCost: 12000,
    rarity: 'rare',
    network: 'base',
  ...
  // Physical Rewards
  {
    id: 'whale-hunter-tshirt',
    title: 'Whale Hunter T-Shirt',
    ...
    maxSupply: 100,
    claimed: false,
    requirements: ['Level 12+', 'Provide shipping address']
  }
];
...
export const Rewards: React.FC<RewardsProps> = ({ userPoints = 15000, userLevel = 7 }) => {
  ...
  const [claimedRewards, setClaimedRewards] = useState<string[]>(['whale-spotter']);
      ...
      <div className="text-center space-y-4">
        ...
        >
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-yellow-400 to-purple-400 bg-clip-text text-transparent">
            Whale Hunter Rewards
          </h1>
          <Sparkles className="w-8 h-8 text-yellow-400" />
        </motion.div>
        <p className="text-gray-400 text-lg">
          Claim exclusive rewards with your whale hunting points
        </p>
      </div>
