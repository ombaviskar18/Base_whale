...
export const XMTPGameChat: React.FC = () => {
  ...
  const initializeXMTP = async () => {
    ...
    setIsConnecting(true);
    console.log('🔄 Initializing Enhanced Whale Hunter Bot...');
    ...
    try {
      ...
      console.log('✅ Enhanced Whale Hunter Bot connected successfully!');
      
      // Add welcome message
      addSystemMessage('🎮 Enhanced Whale Hunter Bot is now online! Type "hi" or /start to begin!');
      ...
      setIsConnectedToXMTP(true);
      setIsConnecting(false);
      addSystemMessage('🎮 Whale Hunter Bot connected! Ready to chat and play trivia!');
      simulateBotInteraction();
    }
  };
  ...
  const simulateBotInteraction = () => {
    setTimeout(() => {
      addBotMessage(`
🐋 **Welcome to Enhanced Whale Hunter!** 🐋
...
Ready to start your whale hunting journey? Type /start! 🚀
  ...
  const handleGreeting = () => {
    const greetingResponses = [
      `👋 **Hello there, fellow whale hunter!** 

Welcome to the Enhanced Whale Hunter Bot! I'm here to help you learn about crypto whales through interactive trivia and real-time monitoring.
...
I'm your friendly Whale Hunter Bot, ready to dive deep into the world of crypto whales with you!
...
Welcome to the upgraded Whale Hunter experience!
...
🎮 Play in rounds - continue or stop after each set!
  ...
  const handleHelpCommand = () => {
    addBotMessage(`
🎮 **ENHANCED WHALE HUNTER COMMANDS** 🎮
...
Thanks for playing Enhanced Whale Hunter! 🐋
    `);
  };
  ...
  const addBotMessage = (content: string) => {
    ...
    const botMessage: ChatMessage = {
      ...
      content,
      sender: 'Enhanced Whale Hunter Bot',
      timestamp: new Date(),
      type: 'bot',
      isOwn: false
    };
  ...
  if (!isConnected) {
    return (
      <div className="backdrop-blur-xl bg-white/5 rounded-xl border border-white/20 p-8 text-center">
        ...
        <p className="text-gray-400">Connect your wallet to start chatting with the Enhanced Whale Hunter Bot</p>
      </div>
    );
  }
      ...
      <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 p-4 border-b border-white/10">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">Enhanced Whale Hunter Bot</h3>
